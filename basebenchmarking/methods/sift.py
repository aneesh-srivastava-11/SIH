"""
SIFT Image Registration Baseline Method.
"""
...
class SIFTMethod(RegistrationMethod):
    """Off-the-shelf SIFT Baseline Adapter."""
    ...
    def is_available(cls) -> Tuple[bool, str]:
        try:
            ...
            return False, "OpenCV SIFT_create returned None"
        except AttributeError:
            return False, "OpenCV installation does not include SIFT (cv2.SIFT_create unavailable)"
        except Exception as e:
            return False, f"SIFT initialization failed: {e}"
    ...
    def run(self, reference_image: np.ndarray, target_image: np.ndarray, config: Any, pair_id: str = "") -> RegistrationResult:
        ...
        return RegistrationResult(
            ...
            metadata={"ratio_threshold": ratio_thresh, "ransac_threshold": ransac_thresh},
        )
